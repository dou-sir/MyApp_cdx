...
public class OilActivity extends AppCompatActivity {
    ...
    private List<Map<String, Object>> oil;
    ...
    private void init(){
        ...
        lv_oil.setAdapter(simpleAdapter);
